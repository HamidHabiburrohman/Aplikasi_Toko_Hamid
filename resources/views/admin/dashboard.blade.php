...
@section('content')
  <div class="content-wrapper">
    <div class="page-header">
      <h3 class="page-title">
        <span class="page-title-icon bg-dark text-white me-2"> <i class="mdi mdi-home"></i>
    ...
    <div class="row">
      ...
      <div class="col-md-4 stretch-card grid-margin">
        <div class="card bg-gradient-info card-img-holder text-white">
          <div class="card-body">
            <img src="{{ asset('admin/images/dashboard/circle.svg')}}" class="card-img-absolute" alt="circle-image" />
            <h4 class="font-weight-normal mb-3">Net Profit <i class="mdi mdi-bookmark-outline mdi-24px float-end"></i>
            </h4>
            <h2 class="mb-5">Rp {{ number_format($netProfit, 0, ',', '.') }}</h2>
            <h6 class="card-text">Laba Bersih</h6>
          </div>
        </div>
      </div>
      <div class="col-md-4 stretch-card grid-margin">
        <div class="card bg-gradient-success card-img-holder text-white">
          <div class="card-body">
            <img src="{{ asset('admin/images/dashboard/circle.svg')}}" class="card-img-absolute" alt="circle-image" />
            <h4 class="font-weight-normal mb-3">Total Transactions <i class="mdi mdi-diamond mdi-24px float-end"></i>
            </h4>
            <h2 class="mb-5">{{ $totalTransactions }}</h2>
            <h6 class="card-text">Total Transaksi</h6>
          </div>
        </div>
      </div>
    </div>
              ...
              <table class="table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td> May 15, 2015 </td>
                    <td>
                      <label class="badge badge-success" style="border-radius: 8px;">DONE</label>
                    </td>
                  </tr>
                </tbody>
              </table>
        ...
        <div class="card" style="border-radius: 20px;">
          <div class="card-body">
            ...
            <div class="add-items d-flex">
              ...
              <button class="add btn btn-dark font-weight-bold todo-list-add-btn" id="add-task">Add</button>
            </div>
